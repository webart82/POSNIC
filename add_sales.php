                ...
                <div class="content-module-main cf">
                    ...
                    if (isset($_POST['total'])) {
                        ...
                        if ($validated_data === false) {
                            ...
                            echo $msg;
                            if($str == ''){
                            echo "<script>window.open('add_sales_print.php?sid=$finalautoid_new','myNewWinsr','width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no');</script>";
                            }
                            if($str != ''){
                            echo "<script>window.open('add_sales_print.php?sid=$finalautoid','myNewWinsr','width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no');</script>";
